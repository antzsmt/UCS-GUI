...
namespace UCS.Packets.Messages.Server
{
    ...
    internal class Inbox_Data : Message
    {
        ...
        public Inbox_Data(Device _Device) : base(_Device)
        {
            this.ID     = PacketID;
        ...
        public override void Encode()
        {
            ...
            this.Writer.AddString("https://56f230c6d142ad8a925f-b174a1d8fb2cf6907e1c742c46071d76.ssl.cf2.rackcdn.com/inbox/ClashRoyale_logo_small.png");
