...
namespace GL.Servers.CR.Files.CSV_Logic
     ...
     class Locations : Data
        ...
        public int MusicStartTime { get; set; }
        public string Sound { get; set; }
        public int SoundStartTime { get; set; }
        public bool SoundPlayOvertime { get; set; }
        public string ExtraTimeMusic { get; set; }
        public int MatchLength { get; set; }
        public string WinCondition { get; set; }
        public int OvertimeSeconds { get; set; }
        public bool NoStartScreen { get; set; }
        public bool NoEndScreen { get; set; }
        public bool HideTopUI { get; set; }
        public bool HideManaBar { get; set; }
